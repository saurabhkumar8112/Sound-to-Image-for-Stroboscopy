...
hdf5_file = h5py.File('DatasetWithLabels.hdf5', "r")
...
''' initialization '''
ckpt_dir = './checkpoints/checkpoints2'
...
try:
    ...
    batch_epoch = 900// (batch_size * n_critic)
    ...
    for it in range(sess.run(it_cnt), max_it):
        ...
        for i in range(n_critic):
            ...
            idx_ipt = np.random.randint(0, 900, batch_size)
        ...
        if (it + 1) % 50 == 0:
            ...
            save_dir = './sample_images_while_training/images2'
